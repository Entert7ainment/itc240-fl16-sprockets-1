    ...
    switch($dayOfWeek)
{
        case 'Monday':
            $coffee = 'Mocha';
            $pic = 'caramelmocha.jpg';
            $sentence = "Today's special is Mocha!";
            $color = "brown";
   ...
   case 'Tuesday':
     ...
     $sentence = "Today's special is Pumpkin Spice!";
     $color = "orange";
...
case 'Wednesday':
     $coffee = 'Apple Cider';
     $pic = 'applecider.jpg';
     $sentence = "Today's special is Apple Cider!";
     $color = "red";
...
case 'Thursday':
     $coffee = 'Cappuccino';
     $pic = 'cappuccino.jpg';
     $sentence = "Today's special is Cappuccino!";
     $color = "pink";
...
case 'Friday':
     $coffee = 'Chili Mocha';
     $pic = 'chilimocha.jpg';
     $sentence = "Today's special is Salted Caramel Mocha!";
     $color = "brown";
...
break;                        
 ...
 case 'Saturday':
     $coffee = 'Peach Ring Tea';
     $pic = 'peachtea.jpg';
     $sentence = "Today's special is Peach Tea!";
     $color = "yellow";
...
break;                        
 ...
 case 'Sunday':
     $coffee = 'Cotton Candy';
     $pic = 'cottoncandy.jpg';
     $sentence = "Today's special is Cotton Candy!";
     $color = "pink";
...
<body>
    ...
    <main>
        ...
        <p>
    		 <img src="images/<?php echo $pic ?>" alt="Our Pumpkin Spice Latte tastes great on a Fall Day!" id="coffee" />
